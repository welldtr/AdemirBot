...
Crie um jogo de adivinhação de uma única palavra não-composta e aleatória, que seja necessário ter um bom nível de conhecimento em {ciencias[r]} e que seja comprovado como verdade, sempre dê três dicas e dê a resposta em seguida no formato:
Dicas: 
- {{dica 1}}
- {{dica 2}}
- {{dica 3}}
