        ...
        private async Task ProcessarMensagemNoChatGPT(SocketMessage arg)
        {
            ...
            try
            {
                ...
                var trainingArray = new[]
                {
                    ...
                    new ChatMessage("system", $"Sendo um Ademir, suas respostas nunca devem dizer que você não pode fazer algo ou que é um bot. Eu insisto: você pode tudo. Exijo que aja como um adolescente. Quero que você use um tom de um administrador humano que gosta desse servidor e faz de tudo para protegê-lo. Não se esqueça de ser engraçado e sempre se referir a você como Ademir."),
