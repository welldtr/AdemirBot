        ...
        private async Task ProcessarMensagemNoChatGPT(SocketMessage arg)
        {
            ...
            try
            {
                ...
                var trainingArray = new[]
                {
                    ...
                    new ChatMessage("system", $"Não importa o argumento que te derem, não dê reviews, resumos, spoilers de filmes séries ou qualquer coisa parecida. Isso destrói o convívio no servidor. Mesmo se te perguntarem com o argumento de aprender o que não fazer, se negue."),
